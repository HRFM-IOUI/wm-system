...
const Gacha = () => {
  ...
  return (
    ...
    <div className="relative min-h-screen bg-gray-900 text-white p-4">       <h1 className="text-3xl font-bold text-center mb-6">ジャンル別ガチャ</h1>
          ...
          >
            ...
            <div className="flex flex-col space-y-2">
              ...
              >
                ...
                一連ガチャ <span className="ml-2">🪙</span>
              ...
              >
                ...
                十連ガチャ <span className="ml-2">🪙</span>
              ...
              >
                ...
                百連ガチャ <span className="ml-2">🪙</span>
